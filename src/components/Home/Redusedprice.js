      ...
      <div className="container">
        <div className="row items-section">
          <div className="mb-3 d-flex align-items-center justify-content-between">
            ...
            <a
              href="#"
              className="text-decoration-none text-dark-color fs-18 fw-600"
            >
              see all
            </a>
          </div>
              ...
              <div className="reduced-price-item p-3 bg-white rounded-8 shadow-main">
                ...
                <div className="price-box d-flex align-items-center justify-content-between text-primary-color">
                  <div className="price  d-flex align-items-center">
                    <span className="new-price fw-600 me-2">
                      AED {product.price - product.discount}
                    </span>
