            ...
            <div className="comming-soon-item p-3 bg-white rounded-8 shadow-main">
              <div className="d-flex align-items-center justify-content-between">
                <div className="sold position-relative text-center">
                  ...
                  >
                    <div className="">
                      <h6 className="fw-600 text-dark-color mb-0 fs-14">800</h6>
                      <p className="mb-0 fw-500 text-dark-color fs-10">sold</p>
                    </div>
                    <div className="">
                      <p className="mb-0 fw-500 text-dark-color fs-10">
                        out of
                      </p>
                      <h6 className="fw-600 text-dark-color mb-0 fs-14">950</h6>
                    </div>
                  </div>
                </div>
              ...
              <div className="add-to-cart d-flex justify-content-around align-items-center">
                ...
                <p className="text-primary-color fs-18 fw-normal mb-0">120 $</p>
              </div>
            </div>
          </div>
        </div>
